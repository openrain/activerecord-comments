...
Read the RDoc[http://openrain.github.com/activerecord-comments]
...
See mysql_adapter.rb[http://github.com/remi/activerecord-comments/tree/master/lib/activerecord-comments/mysql_adapter.rb] for an example of the methods your database adapter 
...
for more MySQL examples, see spec/mysql_comments_spec.rb[http://github.com/remi/activerecord-comments/tree/master/spec/mysql_comments_spec.rb]
